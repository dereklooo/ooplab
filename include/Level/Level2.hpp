...
public:
    ...
    void Update() override {
        ...
        switch (Condition_num) {
            ...
            case 9:
                if(m_Background->GetPosition().x <= -6800 && m_Background->GetPosition().x >= -6850) {
                    _temp.clear();
                    _temp.push_back(std::make_shared<RedTurtle>(glm::vec2(700,-120),Left));
                    m_ManagerManager->AddMonster(_temp,m_renderer);
                    Condition_num += 1;
                }
            default:
...
private:
    ...
    std::vector<glm::vec2> AirBlock={
        ...
        {169.5,-31.5} , {200.5,-31.5},{181.5, -12.5}
    };
