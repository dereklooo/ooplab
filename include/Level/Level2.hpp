...
private:
    ...
    std::vector<glm::vec2> FloorBlock = {{100.5,-14},{50.5f,-31},{120.5,-47},{111.5,-31},{185.5,-32}};
    std::vector<glm::vec2> FloorBlockSize = {{201.f,2.0f},{79.0f,2.0f},{18,2.0f},{37,2.0f},{31,2.0f}};
